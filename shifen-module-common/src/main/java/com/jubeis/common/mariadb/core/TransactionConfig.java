...
public class TransactionConfig {
     ...
     */
    @Bean
    public DataSourceTransactionManager mariadbCoreDataSourceTransactionManager(@Qualifier("mariadbCoreDataSource") DataSource dataSource) {
    ...
    public TransactionInterceptor mariadbCoreDataSourceTxAdvice(@Qualifier("mariadbCoreDataSourceTransactionManager") DataSourceTransactionManager dataSourceTransactionManager) {
        // 默认事务
