package com.jubeis.common.security;

import com.alibaba.fastjson.JSON;
import com.jubeis.common.common.contants.Contants;
import com.jubeis.model.common.dtos.ResponseResult;
import com.jubeis.model.enums.AppHttpCodeEnum;
import com.jubeis.utils.common.UrlSignUtils;
...
public class AdminCheckSignFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        // 测试和开发环境不过滤
        if ( result == null || uri.startsWith("/login")) {//|| !Contants.isProd()
